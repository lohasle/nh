/**
 * Created by lohasle github.com/lohasle on 2014/11/19.
 */
...
;(function(){
    $.cavBg = function(options){
        ...
        function addCSS() {
            ...
            link.type = 'text/css';
            link.rel = 'stylesheet';
            link.href = 'style/cav.css';
            document.getElementsByTagName("head")[0].appendChild(link);
        }
        if (!!document.createElement("canvas").getContext) {
            //addCSS();
            if(_options.enableAnitOut){
                $(this).append('<div  class="anitOut"></div>');
            }
            var t = {
                width: 1.5,
                height: 1.5,
            ...
            var G = {
                ...
                xyScalar: 1,
                zOffset: 100,
                ambient: _options.colorQueue[0][0],
                diffuse: _options.colorQueue[0][1],
                speed: 0.001,
                gravity: 1200,
                dampening: 0.95,
                minLimit: 10,
            ...
            var z =self[0];
            var w =_options.enableAnitOut? $(this).children('.anitOut')[0]:null;
            var D, I, h, q, y;
            var g;
            var r;
                ...
                return {
                    set: function () {
                        if(S){
                            ...
                            //P(_options.colorQueue[0][0]);
                            //P(_options.colorQueue[0][1]);
                        }
                    }
                }
            }
            ...
            var _index = 0;
            var h = _options.colorQueue;
            var st  = setInterval(function () {
                J(h[_index % h.length]).set();
                _index++;
            }, _options.duration);
    ...
    $.fn.cavBg = function(options){
        this.each(function(){
            $.cavBg.call(this,options);
        });
    }
})(jQuery);
